...
const questions = [
    // ===== Domain I: People (42%) — 31 questions =====
    {
        ...
        options: [
            ...
            'Choose the approach recommended by the more senior team member',
            'Escalate the issue to the project sponsor immediately',
            'Assign the work to a third team member to avoid the conflict',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Assigning tasks to each team member daily',
            'Reporting team velocity to stakeholders without context',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Publicly compare other team members unfavorably to this individual',
            'Assign extra work as a reward for early completion',
            'Ignore the performance to avoid showing favoritism',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Continue without them since the project is progressing well',
            'Ask another stakeholder to represent their interests without their knowledge',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Abandon the agile components and revert to fully predictive planning',
            'Let the team choose which methodology to follow independently without guidance',
            'Escalate to the PMO and request the project be cancelled',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Require the team member to present at the next retrospective',
            'Discuss the issue publicly during the retrospective',
    ...
    },
    {
        ...
        options: [
            ...
            'Reduce the project scope to match existing team capabilities',
            'Proceed with the current team and hope they can figure it out',
            'Immediately hire a full-time contractor without evaluating other options',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Terminate the contract immediately and start a new procurement process',
            'Accept the delay without negotiation to preserve the vendor relationship',
            'Threaten the vendor with legal action to enforce the original timeline',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Require all team members to work the same hours regardless of location',
            'Communicate only with the team members in the PM\'s time zone',
            'Cancel all meetings and rely exclusively on email',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Calculating earned value metrics accurately',
            'Creating detailed Gantt charts with proper dependencies',
            'Writing comprehensive risk registers',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Extend the sprint duration to allow more time for work',
            'Set mandatory overtime until velocity recovers',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Override the product owner and let the team decide priorities',
            'Side with the product owner since they own the backlog',
            'Pause the sprint until the disagreement is resolved by upper management',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Impose the PM\'s own cultural norms on the entire team',
            'Ignore cultural differences and treat everyone identically',
            'Separate team members by culture to avoid misunderstandings',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Reject the change outright because the project is nearly complete',
            'Implement the change immediately to keep the stakeholder happy',
            'Defer the decision to the next project phase without analysis',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Make all decisions for the junior PM to prevent mistakes',
            'Assign only simple tasks that require no growth',
            'Provide a written manual and avoid direct interaction',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Tell the team member to work harder because the deadline cannot change',
            'Ignore the complaint since all team members are equally busy',
            'Replace the team member with someone more productive',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Send a detailed 100-page requirements document for review',
            'Assume all stakeholders interpret requirements the same way',
            'Limit communication to formal written memos only',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'The PM\'s preferred font for documents',
            'A detailed org chart of the parent company',
    ...
    },
    {
        ...
        options: [
            ...
            'Tell the team member to follow procedures without asking questions',
            'Remove the procedures to keep the team member happy',
            'Assign the team member to a different project',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Operates without any organizational constraints or reporting requirements',
            'Relies on management to approve every task before starting',
            'Follows a strict command-and-control hierarchy',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Assign unqualified team members to cover the gap without informing stakeholders',
            'Confront the functional manager aggressively in front of their team',
            'Reduce the project scope without CCB approval to accommodate fewer resources',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Team members who work exclusively in one technical specialty',
            'Managers who delegate but never contribute technically',
            'Contractors who work part-time on multiple projects simultaneously',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Keep informed — send periodic updates but limit involvement',
            'Monitor — track their position but minimize communication',
            'Keep satisfied — address their concerns only when they escalate',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Formally reprimand the team member for not following time-tracking procedures',
            'Praise the team member for their dedication and encourage more overtime',
            'Report the team member to HR for policy violation',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Override the team\'s estimate and commit to all stories to satisfy the product owner',
            'Add team members from another project to increase capacity',
            'Extend the sprint by one week to fit all the work',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Only share positive news to maintain stakeholder confidence',
            'Restrict access to the project dashboard to the core team only',
            'Defer all status reporting to the PMO to maintain objectivity',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Attempt to convince the team member to stay at any cost',
            'Ignore the situation until the departure is official',
            'Remove the team member from all work immediately',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Tracking the project schedule and critical path',
            'Calculating the project budget and cost baseline',
            'Measuring team member utilization rates',
        ],
        correctAnswer: 0,
    ...
    // ===== Domain II: Process (50%) — 36 questions =====
    {
        ...
        options: [
            ...
            'Eliminating the need for project planning entirely',
    ...
    },
    {
        ...
        options: [
            ...
            'Define the project\'s total scope for all sprints',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Request additional funding without investigating the cause',
            'Reduce quality standards to cut costs',
            'Hide the variance in the next status report',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Assign individual tasks to team members on a daily basis',
            'Track the critical path of the project schedule',
            'Calculate the project\'s earned value metrics',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Requirements are vague and expected to evolve throughout the project',
            'The buyer wants maximum flexibility to add scope at no additional cost',
            'The project involves cutting-edge research with unpredictable outcomes',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Verifying that deliverables meet quality specifications',
    ...
    },
    {
        ...
        options: [
            'Log the change request and perform an impact analysis',
            'Implement the change immediately if it comes from the sponsor',
            'Reject the change because the baseline should not be modified',
            'Approve the change and update all baselines simultaneously',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Set the maximum number of team members on the project',
            'Define the total number of user stories in the product backlog',
            'Restrict the project budget allocation per sprint',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'The activities with the highest cost',
            'The activities that can be delayed without affecting the project end date',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'It assigns blame for project failures to specific team members',
            'It is required to release project resources',
            'It determines the final project budget',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Replace the sprint review ceremony',
            'Approve the final product for release',
    ...
    },
    {
        ...
        options: [
            ...
            'Contains the detailed project schedule with all dependencies',
            'Replaces the project management plan',
            'Is created by the project manager without sponsor involvement',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Extend the iteration until all stories are complete',
            'Remove the incomplete stories from the project entirely',
            'Mark the stories as complete and move on',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Select vendors through a random lottery',
            'Generate random test cases for quality assurance',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Eliminate the need for a project manager',
            'Ensure all decisions are made by consensus among all stakeholders',
            'Replace the organization\'s existing management hierarchy',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'The risk register and stakeholder register',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Create a new risk register entry for the same event',
            'Wait for the issue to resolve itself',
            'Update the lessons learned but take no immediate action',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Determine the exact project completion date',
            'Eliminate all estimation risk',
            'Assign a fixed budget with no contingency',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Planning the next sprint in detail',
            'Reviewing and updating the team\'s working agreements',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'The PM\'s personal preference for a specific methodology',
            'Whether the organization has used Scrum before',
            'The project budget amount',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Reduced project quality standards',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Obtaining formal acceptance of the final deliverable',
    ...
    },
    {
        ...
        options: [
            ...
            'Test individual deliverables for defects',
            'Assign quality ratings to team members',
            'Calculate the cost of quality for the project budget',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Authorized — the person who approved the project budget',
            'Available — the person who has time in their schedule',
            'Assigned — the person doing the day-to-day work',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Reject all new requirements after the initial release plan is set',
            'Create a separate change control board for each new requirement',
            'Implement them immediately without any prioritization',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'The activity will be completed automatically by the system',
            'The accountable person will also perform the work',
            'The activity can be safely removed from the project scope',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Fast-tracking adds resources; crashing removes dependencies',
            'Fast-tracking increases quality; crashing decreases quality',
            'Fast-tracking is used only in agile; crashing is used only in predictive',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Decide which team members will be laid off',
    ...
    // ===== Domain III: Business Environment (8%) — 6 questions =====
    {
        ...
        options: [
            ...
            'Ignore the regulation since it was not part of the original scope',
            'Shut down the project until the regulation is fully understood',
            'Delegate compliance entirely to the legal department without project integration',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Calculating the project\'s cost savings during execution',
            'Distributing project team bonuses after completion',
            'Measuring team member satisfaction at the end of the project',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Proceed with implementation and expect employees to adapt on their own',
            'Postpone the project indefinitely until all resistance disappears',
            'Discipline employees who resist the change',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Only at the start of the project during initiation',
            'Only at the end of the project during closing',
            'Never — once approved, it should not be questioned',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Ignore the competitor since the project plan is already approved',
            'Cancel the project immediately since the competitor has first-mover advantage',
            'Double the project budget to accelerate delivery without stakeholder approval',
        ],
        correctAnswer: 0,
    ...
    },
    {
        ...
        options: [
            ...
            'Strictly penalizes any project deviation from the original plan',
            'Discourages cross-functional communication to maintain departmental focus',
            'Limits project manager authority to only administrative tasks',
        ],
        correctAnswer: 0,
...
async function main() {
    console.log(`Seeding ${questions.length} PMP questions...`);
    ...
    await batch.commit();
    console.log(`\nDone! ${questions.length} PMP questions added.`);
    process.exit(0);
}
