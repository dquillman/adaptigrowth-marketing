export default function QuestionProvenanceBadge() {
    const tooltipText =
        ...
        "These are original, scenario-based questions written to reflect the decision-making style outlined in the PMI\u00AE PMP Exam Content Outline.\n\n" +
