export default function QuestionProvenanceBadge() {
    const tooltipText =
        ...
        "These are original, scenario-based questions written to reflect the decision-making style outlined in the PMI\u00AE PMP Exam Content Outline (2021).\n\n" +
    ...
    return (
        <p
            ...
            title={tooltipText}
        >
            &#10004; Scenario-based &bull; PMP-style (2021)
        </p>
    );
}
